...
print("### Reading silver data, creating simple gold tables")
...
if table_exists("silver_catalog.default.yellow_taxi"):
    ...
    # Cache to prevent reading from MinIO 4 separate times
    yellow_base.cache()
    # Force the cache action to materialize it in memory
    yellow_base.count()
    ...
    yellow_tip_df.writeTo("gold_catalog.default.yellow_taxi_tips").createOrReplace()
    ...
    yellow_perf_df.writeTo("gold_catalog.default.yellow_taxi_performance").createOrReplace()
    ...
    yellow_fin_df.writeTo("gold_catalog.default.yellow_taxi_financials").createOrReplace()
    ...
    yellow_class_df.writeTo("gold_catalog.default.yellow_taxi_classifications").createOrReplace()
    
    # Free memory once we are done with Yellow
    yellow_base.unpersist()
else:
    print("### Skip yellow gold: silver table missing")

# ----------------------
# GREEN GOLD
# ----------------------
if table_exists("silver_catalog.default.green_taxi"):
    green_df = spark.read.table("silver_catalog.default.green_taxi")
    ...
    green_tip_df.writeTo("gold_catalog.default.green_taxi_tips").createOrReplace()
    ...
    green_perf_df.writeTo("gold_catalog.default.green_taxi_performance").createOrReplace()
    ...
    green_fin_df.writeTo("gold_catalog.default.green_taxi_financials").createOrReplace()
    ...
    green_class_df.writeTo("gold_catalog.default.green_taxi_classifications").createOrReplace()
    
    # Free memory once we are done with Green
    green_base.unpersist()
else:
    print("### Skip green gold: silver table missing")

# ----------------------
# FHV GOLD
# ----------------------
if table_exists("silver_catalog.default.fhv_trip"):
    fhv_df = spark.read.table("silver_catalog.default.fhv_trip")
    ...
    fhv_summary.writeTo("gold_catalog.default.fhv_trip_summary").createOrReplace()
else:
    print("### Skip fhv gold: silver table missing")

# ----------------------
# FHVHV GOLD
# ----------------------
if table_exists("silver_catalog.default.fhvhv_trip"):
    fhvhv_df = spark.read.table("silver_catalog.default.fhvhv_trip")
    ...
    fhvhv_summary.writeTo("gold_catalog.default.fhvhv_trip_summary").createOrReplace()
else:
    print("### Skip fhvhv gold: silver table missing")
