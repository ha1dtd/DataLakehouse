# Lakehouse Installer Test Matrix

## Purpose

This matrix defines the minimum scenarios the Lakehouse installer must support before new UX or feature work is considered done.
...
- Start:
  - Lakehouse cluster already working
- Expected:
...
- Start:
  - DataNode has incomplete Lakehouse-managed state
  - examples:
    - missing env block
...
- Start:
  - operator wants to install Lakehouse-managed paths outside the default base layout
- Input:
