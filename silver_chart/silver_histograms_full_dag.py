...
with DAG(dag_id="silver_histograms_full", default_args=default_args, schedule_interval=None, catchup=False) as dag:
    run_hist = BashOperator(
        task_id="generate_full_histograms",
        bash_command=f"""
        ...
        {S3A_CONF} \
        {SCRIPT_BASE}/silver_histograms.py --mode full --bucket histogram --sample-fraction 0.2 --seed 42 --bins 50
"""
    )
