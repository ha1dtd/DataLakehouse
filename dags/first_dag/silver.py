...
print("### Bronze to Silver: normalize schema families safely")
...
def detect_yellow_schema(path: str) -> str:
    # Sample 1 row only — avoids full file scan just to read column names
...
# YELLOW
# ----------------------
yellow_paths = glob_paths("s3a://bronze/raw/yellow_tripdata_*.parquet")
...
if yellow_paths:
    ...
    if branch_dfs:
        ...
        yellow_silver.writeTo("silver_catalog.default.yellow_taxi").createOrReplace()
        print("### Wrote silver_catalog.default.yellow_taxi")
else:
    print("### Skip yellow_taxi: no matching raw files")

# ----------------------
# GREEN
# ----------------------
green_paths = glob_paths("s3a://bronze/raw/green_tripdata_*.parquet")
...
if green_paths:
    ...
    green_silver.writeTo("silver_catalog.default.green_taxi").createOrReplace()
    print("### Wrote silver_catalog.default.green_taxi")
else:
    print("### Skip green_taxi: no matching raw files")

# ----------------------
# FHV
# ----------------------
fhv_paths = glob_paths("s3a://bronze/raw/fhv_tripdata_*.parquet")
...
if fhv_paths:
    ...
    fhv_silver.writeTo("silver_catalog.default.fhv_trip").createOrReplace()
    print("### Wrote silver_catalog.default.fhv_trip")
else:
    print("### Skip fhv_trip: no matching raw files")

# ----------------------
# FHVHV
# ----------------------
fhvhv_paths = glob_paths("s3a://bronze/raw/fhvhv_tripdata_*.parquet")
...
if fhvhv_paths:
    ...
    fhvhv_silver.writeTo("silver_catalog.default.fhvhv_trip").createOrReplace()
    print("### Wrote silver_catalog.default.fhvhv_trip")
else:
    print("### Skip fhvhv_trip: no matching raw files")
