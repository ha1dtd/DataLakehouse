...
AIRFLOW_USER = "admin"
AIRFLOW_PASS = "admin"
AIRFLOW_DAG_ID = os.environ.get("FOXAI_AIRFLOW_DAG_ID", "realtime_validate")
DEFAULT_BUCKET = os.environ.get("FOXAI_MINIO_BUCKET", "histogram")
DEFAULT_EVENT_PREFIX = os.environ.get("FOXAI_EVENT_PREFIX", "demo/realtime_validate_fare_amount/event")
    ...
    while not SHOULD_STOP:
        ...
        try:
            ...
            while not SHOULD_STOP:
                ...
                if message_type not in {"file", "row", "row_batch"}:
                    log(
                        {
                            "status": "ignored",
                            "queue": DEFAULT_QUEUE,
