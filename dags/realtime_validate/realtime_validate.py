...
SCRIPT_BASE = "/home/ubuntu/daihai_script/realtime_validate"
SPARK_COMMON = """
        --master yarn \
        --deploy-mode client \
        --driver-memory 2G \
...
""".strip()
STATE_PREFIX = "demo/realtime_validate_fare_amount/state"
...
with DAG(
    ...
    ingest_event = BashOperator(
        ...
        python3 /home/ubuntu/daihai_script/realtime_validate/realtime_fare_amount_rabbitmq_ingest_event.py \
        --bucket histogram \
        --state-prefix demo/realtime_validate_fare_amount/state \
...
""",
    ...
    calculate = BashOperator(
        ...
        {SPARK_COMMON} \
        {S3A_CONF} \
        {SCRIPT_BASE}/realtime_fare_amount_rabbitmq_calculation_job.py \
        --bucket histogram \
